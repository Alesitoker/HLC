<?php
  ...
  //directorio debe tener los permisos necesario para poder leer y escribir
  //en él.
  $uploads_dir = 'files';

  //Como para cada clave del array $_FILES va contener un array, en el caso de que
...
// Ya tengo el nombre del archivo ($name) y la ruta donde esta, ahora necesito
//crear la ruta de destino:
          if(move_uploaded_file($tmp_name, "$uploads_dir/$name")){
// Ya lo hemos movido ahora quiero abrir y escribir en el:
//NUEVO
            /*Abrimos el fichero que acabamos de mover.  */

            $r_file = fopen("$uploads_dir/$name", 'a+b');
      // la funcion fopen(ruata del fichero, modo de apertura)
